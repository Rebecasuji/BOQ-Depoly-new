...
export default function PlumbingEstimator() {
  ...
  const getMaterialsWithQuantities = (): MaterialWithQuantity[] => {
    ...
    return allMaterials.map(mat => {
      let quantity = 0;
      if (mat.code === "PLUMB-001") {
        quantity = Math.ceil(a / 25);
      } else if (mat.code === "PLUMB-002") {
        quantity = Math.ceil(a / 500);
      } else if (mat.code === "PLUMB-003") {
        quantity = Math.ceil(a / 200);
      } else if (mat.code === "PLUMB-004") {
        quantity = Math.ceil(a / 20);
      } else if (mat.code === "PLUMB-005" || mat.code === "PLUMB-008") {
        quantity = Math.ceil(a / 300);
      } else if (mat.code === "PLUMB-006") {
        quantity = Math.ceil(a / 600);
      } else if (mat.code === "PLUMB-007") {
  ...
  const handleExportBOQ = () => {
    ...
    a.href = url;
    a.download = `BOQ-Plumbing-${new Date().getTime()}.csv`;
    a.click();
